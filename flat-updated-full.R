...
#population
N <- covidvax$population[30] #total population on March 1, 2021
...
flat$I_vax_active[1] #285276 for Iv
flat$I_unvax_active[1] #928838 for Iu
flat$R_total[1] #1329269 for R
flat$cum_vax_deaths[1] + flat$cum_unvax_deaths[1] #17556 for D
flat$population_vaccinated[1] - flat$cum_vax[1] #16356633 for Sv
flat$population_unvaccinated[1] - flat$cum_unvax[1] #4412601 for Su
